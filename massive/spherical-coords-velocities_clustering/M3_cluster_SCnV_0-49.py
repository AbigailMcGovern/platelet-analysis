...
sp = os.path.join(d, f'211206_saline_df_spherical-coords_0-49_{dt}.parquet')
...
# save plots here
save_dir = f'/fs02/rl54/clustering/{dt}_UMAP-DBSCAN_SCnV_0-49'
...
multi_basic_scatter_save(df, umap_cols[0], umap_cols[1], cols, save_dir, f'UMAP-DBSCAN_SCnV_0-49')
