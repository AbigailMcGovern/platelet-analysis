...
sp = os.path.join(d, f'211206_saline_df_spherical-coords_100-193_{dt}.parquet')
...
# save plots here
save_dir = f'/fs02/rl54/clustering/{dt}_UMAP-DBSCAN_SCnV_100-193'
...
multi_basic_scatter_save(df, umap_cols[0], umap_cols[1], cols, save_dir, f'UMAP-DBSCAN_SCnV_100-193')
