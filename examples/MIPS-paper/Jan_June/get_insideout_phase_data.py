from plateletanalysis import experiment_phase_insideout_data, add_basic_variables_to_files
import pandas as pd
import os
...
save_path = '/Users/abigailmcgovern/Data/platelet-analysis/MIPS/Figure_3/230518_experiment_phase_insideout_onlylargeFalse.csv'

experiment_phase_insideout_data(df, peaks, save_path, only_large=False)